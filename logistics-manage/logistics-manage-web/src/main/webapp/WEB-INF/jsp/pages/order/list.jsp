...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/messagelis/messagelis.js"></script>
...
<div class="weadmin-body">
    ...
    <div class="weadmin-block">
        <button class="layui-btn layui-btn-danger" data-type="checkstatus"><i class="layui-icon"></i>批量删除</button>
        <button class="layui-btn" onclick="WeAdminShow('添加订单','./add.html')"><i class="layui-icon"></i>添加</button>

    </div>
    <button class="layui-btn" onclick="WeAdminShow('imgs','./imgs.html')"><i class="layui-icon"></i>ss</button>
    <table id="message-lis" class="layui-table">
        <%--<thead>--%>
        <%--<tr>--%>
        <%--<th>--%>
