...
<script type="text/html" id="unbarDemo">
    <a class="layui-btn layui-btn-xs" lay-event="edit">取消收件</a>
</script>
...
layui.use(['form','jquery','table'],function(){
    ...
    var tableIns= table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{fixed: 'right', title:'操作', toolbar: '#unbarDemo', width:120,align:"center"}
    ...
    function unreceive(orderIds,status) {
        layer.confirm("确认取消收件吗?",
            function(index){
                //console.log(id);
                layer.close(index);
                ...
                $.ajax({
                    ...
                    success:function (res) {
                        if(res.success){
                            ...
                            location.href="${pageContext.request.contextPath}/delivery/undeliveryList";
