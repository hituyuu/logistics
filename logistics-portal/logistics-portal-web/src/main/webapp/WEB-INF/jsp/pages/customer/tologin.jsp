...
<head>
    ...
    <script>
        ...
        function login(){//登录
            ...
            if(flag){
                ...
                type:"post",
                data:{"cname":cname,"password":password},
                dataType:"text",
        ...
        function register(){
            ...
            if(cname!=null){
                $.ajax({
                    async:false,
                    url:"${pageContext.request.contextPath}/checkcname",
                    type:"post",
                    data:{"cname":cname},
                    dataType:"json",
                    success:function(rec){
                        if(rec=="1"){
                            alert("用户名已存在");
                            <%--location.href="${pageContext.request.contextPath}/pages/customer/tologin";--%>
                        }else{
                            $.ajax({
                                url:"${pageContext.request.contextPath}/addcname",
                                type:"post",
                                data:{"cname":cname,"password":password},
                                dataType:"text",})
    ...
    <style type="text/css">
        ...
        body{
            ...
            background-image: url(${pageContext.request.contextPath}/static/images/snow.jpg);
                ...
                <div class="pad input-container">
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="login-cname"
                                       autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15" />
								<label class="input__label input__label--hideo" for="login-cname">
        ...
        <div class="login sign-up-htm">
            <form action="#" method="post" class="container offset1 loginform">
                ...
                <div class="pad input-container">
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-cname"
                                       autocomplete="off" placeholder="请输入用户名" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-cname">
                                    <i class="fa fa-fw fa-user icon icon--hideo"></i>
                                    <span class="input__label-content input__label-content--hideo"></span>
                                </label>
							</span>
